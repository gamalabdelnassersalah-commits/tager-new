...
const copyFiles = ['index.html','tager-logo.png','logo.svg','style.css','styles.css','globals.css','inline.js','app.js','config.js','schema_final.sql','signature-gamal-stamp.png','invoice-design-reference.png','order-design-reference.png'];
